...
export const BeachHoliday = () => {
  return (
    <div className='beach-holiday'>
      <Container>
        <Row>
          <h4 className='text-uppercase fw-bold text-center'>BEACH TOUR PACKAGES</h4>
          <div className="beach-holiday-icon mx-auto mt-2" />
          <h1 className='fw-bold text-center mt-3 mb-5'>Beach Holiday</h1>
